...
```
*Since the p value is 0.01408 is greater than 0.01, we accept the null hypothesis, where there is no statistically signifigant difference at the %99 confidence interval*
...
test1$conf.int
```
*The confidence interval is 4.006294, 5.083069 , which is different from the -0.06001102, 2.34757335in test1*
